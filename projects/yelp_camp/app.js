...
const sessionConfig = {
    name: 'session', // Specifying a session name is more secure than the default one.
    secret,
    resave: false,
    saveUninitialized: true,
    cookie: {
        httpOnly: true,
        // secure: true, // To be used only for a https protocol.
    ...
    helmet.contentSecurityPolicy({
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/olufemi/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT! 
